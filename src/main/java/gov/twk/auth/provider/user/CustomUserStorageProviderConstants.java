...
public final class CustomUserStorageProviderConstants {
    ...
    public static final String CONFIG_KEY_DB_USERS_TABLE_NAME = "usersTableName";
    public static final String CONFIG_KEY_DB_ROLES_TABLE_NAME = "rolesTableName";
    public static final String CONFIG_KEY_USER_FIRST_NAME_FIELD_NAME = "firstName";
